    ...
    useEffect(() => {
        ...
        const request = async () => {
            ...
            if (response.ok) {
                ...
                setApiResponse((prevState) => ({ ...prevState, status: apiStatusConstants.success, data: bookData }))
            } else {
        ...
        return <div className="details-container">
             <figure className="figure-details">
              ...
              <figcaption className="figure-captions">
                ...
                <p className="sub-headings">Price: <span className="span"> {data.price} </span></p>
